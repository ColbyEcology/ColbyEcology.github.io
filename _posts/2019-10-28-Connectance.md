---
layout: post
title: Understanding connectance
...
The firs two correspond to webs where all species potentially consume/interact each other (i.e., 2-way interactions). The second two correspond where all species potentially consume/interact in a unidirectional manner (i.e., 1-way interactions). The first and third include cannibalism; the second and fourth do not include cannibalism.
